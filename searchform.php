...
<form method="get" name="articlesearchform" class="searchform"  action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input type="text" class="field" name="s" id="s" placeholder="<?php esc_html_e( 'Search', 'otm-skeleton' ); ?>">
	<input type="submit" class="submit" name="submit" value="<?php esc_html_e( 'GO', 'otm-skeleton' ); ?>"/>
